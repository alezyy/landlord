<div class="accountings index">
	...
	<tr>
		...
		<td><?php echo h($accounting['Accounting']['tenant_id']); ?>&nbsp;</td>
		<td><?php echo h($accounting['Accounting']['payment_id']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $accounting['Accounting']['id']), array(), __('Are you sure you want to delete # %s?', $accounting['Accounting']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
