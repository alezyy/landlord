					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Leasestype'), array('action' => 'add'), array('escape' => false)); ?></li>
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($leasestypes as $leasestype): ?>
					<tr>
						...
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $leasestype['Leasestype']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $leasestype['Leasestype']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $leasestype['Leasestype']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $leasestype['Leasestype']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
