	...
	<div class="row">
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('unikkey'); ?></th>
						<th class="actions"></th>
					</tr>
				</thead>
				<tbody>
			...
			<?php echo $this->Html->link($participant['Competition']['title'], array('controller' => 'competitions', 'action' => 'view', $participant['Competition']['id'])); ?>
						...
						<td><?php echo h($participant['Participant']['firstname']); ?>&nbsp;</td>
						<td><?php echo h($participant['Participant']['lastname']); ?>&nbsp;</td>
						<td><?php echo h($participant['Participant']['email']); ?>&nbsp;</td>
						<td><?php echo h($participant['Participant']['newsletter']); ?>&nbsp;</td>
						<td><?php echo h($participant['Participant']['winner']); ?>&nbsp;</td>
						<td><?php echo h($participant['Participant']['unikkey']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $participant['Participant']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $participant['Participant']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $participant['Participant']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $participant['Participant']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
