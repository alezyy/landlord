	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Add Rental Owner'); ?></h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('RentalOwner', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('gender_id', array('label'=>__('Choose Gender'),
                                                            'empty'=>__('Select Gender'),
                                 'options'=>$genders, 'selected'=>false,'class' => 'form-control', 'placeholder' => 'Gender Id'));?>
				</div>
				<div class="form-group">
